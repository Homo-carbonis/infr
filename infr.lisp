...
(defpackage :infr
  ...
  (:export :generate-markov-chain :estimate-parameters :likelihood :posteriors))
...
(defun estimate-parameters (model prior y &key (offset 1) (sample-count 100))
...
(defun likelihood (model y &key (offset 1))
  ...
  (iter (for i from offset below (length y))
        ...
        (multiply (pdf (funcall model y) (aref y i)))
